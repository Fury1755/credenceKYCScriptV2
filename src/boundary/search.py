...
def google_search(
    page: Page, individual: Individual, individual_name: str, screenshots: dict
):
...
def search_for_individual(
    page: Page, individual: Individual
...
def search_master(
    page: Page, kah_list: List[Individual]
